...
export async function handleUnmuteCommand(sock, msg, args, sender) {
  ...
  try {
    ...
    return sock.sendMessage(from, { text: '🔓 *Grupo Aberto!* Todos os membros podem enviar mensagens novamente.' }, { quoted: msg });
  } catch (err) {
    return sock.sendMessage(from, { text: '⚠️ Não foi possível abrir o grupo. Verifique se o bot é administrador.' }, { quoted: msg });
  }
}
